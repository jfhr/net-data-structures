...
namespace NetDataStructures.UnitTests.DESPDA
{
    /// <summary>
    ...
    {
        private DeterministicEmptyStackAcceptingPushdownAutomaton _target;

        [TestInitialize]
        public void Initialize()
        {
            _target = new DeterministicEmptyStackAcceptingPushdownAutomaton(
                alphabet: new[] {'a', 'b', 's'},
