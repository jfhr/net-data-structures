...
namespace NetDataStructures.UnitTests.NDESPDA
{
    /// <summary>
    ...
    {
        private NondeterministicEmptyStackAcceptingPushdownAutomaton _target;

        [TestInitialize]
        public void Initialize()
        {
            _target = new NondeterministicEmptyStackAcceptingPushdownAutomaton(
                alphabet: new[] {'a', 'b'},
